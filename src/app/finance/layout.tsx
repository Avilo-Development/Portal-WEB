...
import { Bars3Icon, ChartBarIcon, ChevronDownIcon, PlusIcon, XMarkIcon } from "@heroicons/react/24/outline"
...

                    {
                        routes.map((route): any => (
                            route.childs ?
                                            ...
                                            {route.childs.map((item) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-auto">
                                                        <a href={"/"+current_path + item.href} className="block font-semibold text-gray-900 text-nowrap">
                                                            {item.name}
                                ...
                                :
                                <a key={route.name} href={"/"+current_path + route.url} className="text-sm/6 font-semibold text-gray-900">
                                    {route.name}
                                </a>
                        ))
                    }
